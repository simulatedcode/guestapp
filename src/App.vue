  ...
  <div class="bg-purple-50 min-h-screen">
    <div>
      ...
      <div class="max-w-3xl mx-auto p-6">
        <div class="rounded-xl border bg-white border-purple-600">
          <div class="px-12 py-8">
            <div>
              <h1 class="text-2xl font-semibold">Welcome to Rumah IVAA</h1>
              <p class="text-sm text-gray-600 pt-4">
                We are grateful for your visit, kindly take a moment to fill out
                your contact information and provide us with feedback. Your
                comments will help us improve our service delivery to you in the
                future.
              </p>
            </div>
